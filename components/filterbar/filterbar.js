import Component from '../componentfilterbar'
...
export default {
    ...
    init(opts = {}) {
        ...
        const component = new Component({
            ...
            methods: {
                ...
                */
                bindPickerChange(e) {
                  console.log('picker发送选择改变，携带下标为', e.data.value)
                  console.log('picker发送选择改变，携带值为', e.data.array[e.placeData.value])
                  this.setData({
                    index: e.data.value
                  })
                },
  ...
  // < !--商区-->
  //   <view class="section">
  //     <view class="section__title"><text size="50rpx">选择商区</text></view>
